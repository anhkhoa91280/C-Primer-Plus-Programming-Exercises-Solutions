...
int main() {
	...
	std::cout << "D's size is: " << sizeof(234.0) << std::endl;

	std::cout << "\nA floating-point constant F defined as 234.0f is a float" 
		<< std::endl;
	std::cout <<"F's size is: " << sizeof(234.0F) << std::endl;

	std::cout << "\nA floating-point constant LD defined as 234.0L is a long doulbe" 		<< std::endl;
	std::cout <<"LD's size is: " << sizeof(234.0L) << std::endl;
